        ...
        <main>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 min-h-screen bg-gray-100 gap-8 items-center">
                    <div className="w-full">
                        <img
                            ...
                            alt="Profile"
                            className="h-screen xl:max-w-full w-full object-cover"
                        />
                    </div>
                    <div className="px-4 py-8 flex flex-col items-center md:items-start text-center md:text-left">
                        <h1 className="text-4xl md:text-5xl font-bold text-title mb-4">
                            Welcome to
                            <span className="text-stroke  text-transparent"> My Portfolio</span>
                        </h1>
            ...
            <section ref={introRef} className="section-animate p-5 sm:p-10 text-left">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                    <div className="">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold text-title mb-4 text-stroke  text-transparent">Introduction</h2>
                        ...
                        <div className="py-4">
                            <h2 className="text-2xl md:text-3xl font-bold text-title mb-4 text-stroke  text-transparent">Skills</h2>
            ...
            <section className="bg-gray-100 section-animate">
                ...
                <div id="about" className="p-5 sm:p-10 text-left">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 items-start mb-8">
                        <div className="py-4">
                            <h2 className="text-4xl md:text-5xl font-bold text-title mb-4 text-stroke  text-transparent">About Me</h2>
                        </div>
                        <div>
            ...
            <section id="career" className="section-animate">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
                    <div className="p-5 sm:p-10 text-left">
                        <h3 className="text-4xl md:text-5xl font-bold text-title mb-4 text-stroke  text-transparent">Career</h3>
            ...
            <section id="projects" className="bg-gray-100 section-animate">
                <div className="p-5 sm:p-10 text-left">
                    <h4 className="text-4xl md:text-5xl font-bold text-title mb-4 text-stroke  text-transparent">Projects</h4>
            ...
            <section id="contact" className="section-animate">
                <div className="p-5 sm:p-10 text-left">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 items-center">
                        ...
                        <div>
                            <h2 className="text-4xl md:text-5xl font-bold text-title mb-4 text-stroke  text-transparent">Contact Me</h2>
            ...
            <section className="bg-gray-100 section-animate" id="thankyou">
                <div className="p-5 sm:p-10 text-center">
                    <h6 className="text-4xl md:text-5xl font-bold text-title mb-4 text-stroke  text-transparent">Thank You!</h6>
